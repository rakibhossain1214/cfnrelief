...
<img class="navbar-brand" src="{{ asset('/images/logo.png') }}" width="120" height="80" alt="...">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{ url('/allocate-relief-upazilla')}}">Allocate Relief<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{ url('/relief-checker')}}">Relief Checker<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{ url('/notifications')}}">Notifications<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{ url('/requests')}}">Requests<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
